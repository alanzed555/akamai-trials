var _cf = _cf || [],
    bmak = bmak || {
            ...
            try {
                if (bmak.bpd(),
                    ...
                    if (document.getElementById("bm-telemetry") && (document.getElementById("bm-telemetry").value = bmak.sensor_data),
                        ...
                        for (var a = document.getElementsByName("bm-telemetry"), t = 0; t < a.length; t++)
                            a[t].value = bmak.sensor_data
                } else
                    for (var t = 0; t < bmak.sdfn.length; t++)
                        document.getElementById(bmak.sdfn[t]) && (document.getElementById(bmak.sdfn[t]).value = bmak.sensor_data)
            } catch (a) {
        ...
        call_gp: function () {
            var a;
            void 0 !== window.XMLHttpRequest ? a = new XMLHttpRequest : void 0 !== window.XDomainRequest ? (a = new XDomainRequest,
                    a.onload = function () {
                        this.readyState = 4,
        ...
        pd: function (a) {
            bmak.check_stop_protocol() && (bmak.apicall_bm(bmak.cf_url, a, bmak.patp),
        ...
        a.fpcf = t,
            ...
            t.data = function () {
                ...
                return r = bmak.runFonts ? bmak.altFonts ? t.fonts_optm() : t.fonts() : "dis",
                    [t.canvas("<@nv45. F1n63r,Pr1n71n6!"), t.canvas("m,Ev!xV67BaU> eh2m<f3AG3@"), r, t.pluginInfo(), t.sessionStorageKey(), t.localStorageKey(), t.indexedDbKey(), t.timezoneOffsetKey(), t.webrtcKey(), a, e, n, o, m].join(";")
            },
